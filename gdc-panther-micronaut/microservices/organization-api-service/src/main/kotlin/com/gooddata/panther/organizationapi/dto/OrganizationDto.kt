...
data class OrganizationDto(
    ...
    private fun validateEntitlements() {
        val contractEntitlement = entitlementsConverted.getOrDefault("CONTRACT", "")
        require(contractEntitlement != null && REGEX_EXPIRY.matches(contractEntitlement)) {
            "Entitlement 'Contract' has invalid value"
        }

        val managedOidcEntitlement = entitlementsConverted.getOrDefault("MANAGED_OIDC", "")
        if (managedOidcEntitlement == null || managedOidcEntitlement.isBlank()) {
