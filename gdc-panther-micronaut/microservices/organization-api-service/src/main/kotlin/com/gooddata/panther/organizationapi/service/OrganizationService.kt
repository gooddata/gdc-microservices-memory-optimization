...
class OrganizationService(
    private val organizationServiceConfig: OrganizationServiceConfig,
    private val organizationRepositoryProperties: OrganizationRepositoryProperties,
    private val organizationProperties: OrganizationProperties,
    private val kubernetesService: KubernetesService,
    private val organizationTierPropertyService: OrganizationTierPropertyService,
     ...
     */
    suspend fun deleteOrganization(orgId: String, cluster: String, deployment: String) {
        logger.info(
        ...
        withContext(Dispatchers.IO) {
            metricLogger.durationWithCounter(MetricTimerType.DELETE_ORG_DURATION, MetricCounterType.DELETE_ORG) {
                deleteOrgInRepository(orgId, cluster, deployment)
            }
        }
    }
    ...
    private fun createOrganizationInKubernetes(definition: OrgDefinition) {
        metricLogger.durationWithCounter(
            MetricTimerType.CREATE_ORG_K8S_DURATION,
